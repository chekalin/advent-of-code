...
class ProgramTest {
    ...
    void testMultipleInput() {
        ...
        Program.process(program, 100, 200);
    ...
    void testOutput() {
        int[] program = {4, 2, 99};
        int[] output = Program.process(program);
    ...
    void testCase1() {
        ...
        assertThat(Program.process(program.clone(), 0)).isEqualTo(new int[]{0});
        assertThat(Program.process(program.clone(), 123)).isEqualTo(new int[]{1});
    }
    ...
    void testCase3() {
        ...
        assertThat(Program.process(program.clone(), 7)).isEqualTo(new int[]{999});
        assertThat(Program.process(program.clone(), 8)).isEqualTo(new int[]{1000});
        assertThat(Program.process(program.clone(), 9)).isEqualTo(new int[]{1001});
    }

    @Test
    void assignment() {
        int[] program = readProgramInput("day5/input.txt");
        int[] result1 = Program.process(program.clone(), 1);
        System.out.println("result1 = " + Arrays.toString(result1));
        int[] result2 = Program.process(program.clone(), 5);
